          ...
          <form action="" method="post">
               <div class="form">
                    ...
                    <div class="input_field">
                         ...
                         <a><button type="button" class="btn1" name="Otpbt">Send OTP</button></a>
                    ...
                    <div class="input_field">
                         ...
                         <input type="number" class="input" name="Otp" placeholder="Enter OTP" required>
                    </div>
